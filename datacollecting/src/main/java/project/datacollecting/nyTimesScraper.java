...
public class nyTimesScraper {
    ...
    private static void scrapeNYTimesArticles(WebDriver newBrowser, String link, JSONObject content){
        ...
        List<WebElement> web_tags = new LinkedList<>();
        web_tags.addAll(newBrowser.findElements(By.className("tags-list__item")));

        List<String> tags = new LinkedList<>();

        for (WebElement tag : web_tags){
    ...
    public static void main(String[] args) {
        ...
        seleniumHelper.scroll(browser, 0);
